// As actions de TODO o módulo Comercial vivem aqui: as telas filhas postam para
// `/comercial?/<acao>` (mesmo padrão do Calendário Editorial). Sub-rota não
// precisa reimplementar nada, e o formulário continua funcionando sem JS.
